...
const descriptions: Record<string, string> = {
  ...
  think:"显示或隐藏模型返回的推理或摘要", model:"查看可用模型并切换", mode:"调整推理强度：low / high / xhigh / max", connect:"登录 ChatGPT 或配置 API 模型",
  ...
  reconnect:"重新连接已断开的会话后端", restart:"当前工作交付后受控重启后端", wakeup:"查看、取消或设置会话提醒", peers:"查看本机其他 Astra 会话和往来任务；name 可给本会话改名", help:"打开全部命令与功能",
};
